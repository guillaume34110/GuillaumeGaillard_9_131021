        ...
        const bills = snapshot.docs
          .map(doc => {
            try {
              ...
              // if for some reason, corrupted data was introduced, we manage here failing formatDate function log the error and return unformatted date in that case//console.log(e,'for',doc.data())
